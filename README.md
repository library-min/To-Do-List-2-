...
```javascript
{
  ...
  createdAt: "2024-01-01T00:00:00.000Z",
  dueDate: "2024-01-02", // YYYY-MM-DD or null
  notes: "추가 메모", // string or null
...
| 화면 크기 | 레이아웃 | 통계 카드 | 사이드바 |
|-----------|----------|----------|----------|
| **모바일** (< 640px) | 1열 | 2x3 그리드 | 숨김/토글 |
| **태블릿** (640px - 1024px) | 2열 | 5x1 그리드 | 접힘 모드 |
| **데스크톱** (> 1024px) | 3열 (4:1) | 5x1 그리드 | 항상 표시 |
